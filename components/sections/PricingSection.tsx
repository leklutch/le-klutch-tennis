      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <Card className="bg-[#064423]/10 shadow-md hover:shadow-xl transition duration-300 transform scale-105">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold mb-4 text-center">
                {content.coachLesson.title}
              </h3>
              <p className="text-4xl font-bold text-center mb-6">
                {content.coachLesson.price}
              </p>
              <ul className="space-y-2 mb-6">
          ...
          <Card className="bg-[#064423]/5 shadow-md hover:shadow-xl transition duration-300">
            <CardContent className="p-6">
              <h3 className="text-2xl font-bold mb-4 text-center">
                {content.groupLesson.title}
              </h3>
              <p className="text-4xl font-bold text-center mb-6">
                {content.groupLesson.price}
              </p>
              <ul className="space-y-2 mb-6">
          ...
          <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
            ...
            <DialogContent className="max-w-4xl">
              ...
              <div className="overflow-y-auto max-h-[70vh]">
                ...
                <p className="mb-2">
                  {content.detailedInfo.groupLessons.description}
                </p>
                <table className="w-full border-collapse border border-gray-300 mb-6">
                  <thead>
                    <tr className="bg-green-100">
                      {content.detailedInfo.groupLessons.tableHeaders.map(
                        (header, index) => (
                          <th
                            key={index}
                  ...
                  <tbody>
                    {content.detailedInfo.groupLessons.packages.map(
                      (pkg, index) => (
                        <tr key={index}>
                ...
                <table className="w-full border-collapse border border-gray-300 mb-6">
                  <thead>
                    <tr className="bg-green-100">
                      {content.detailedInfo.coachLessons.tableHeaders.map(
                        (header, index) => (
                          <th
                            key={index}
                            className="border border-gray-300 p-2"
                  ...
                  <tbody>
                    {content.detailedInfo.coachLessons.packages.map(
                      (pkg, index) => (
                        <tr key={index}>
                          <td className="border border-gray-300 p-2">
                            {pkg.name}
                ...
                <div className="p-4 rounded-lg">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-2">
                      <p className="font-semibold">
                        {content.detailedInfo.paymentInfo.bank}
                      </p>
                      <p className="text-gray-700">
                        {content.detailedInfo.paymentInfo.bankValue}
                      </p>
                    </div>
                    <div className="space-y-2">
                      <p className="font-semibold">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <button
                          onClick={() =>
                            copyToClipboard(
                              content.detailedInfo.paymentInfo
                                .accountNumberValue
                            )
                          }
                          className="p-1 rounded-md hover:bg-green-100 transition-colors"
                          aria-label={
                            content.detailedInfo.paymentInfo.copyButton
                          }
                        >
                          {copied ? (
                ...
                <div className="bg-green-100 p-4 rounded-lg">
                  <h4 className="font-bold mb-2">
                    {content.detailedInfo.notes.title}
                  </h4>
                  ...
                  <ul className="list-disc list-inside ml-4">
                    {content.detailedInfo.notes.requiredInfo.map(
                      (info, index) => (
                  ...
                  <p className="mt-2">
                    {content.detailedInfo.notes.confirmation}
                  </p>
                </div>
              </div>
            </DialogContent>
