...
const AboutSection = ({ content }: { content: AboutSectionContent }) => {
  return (
    <section id="about" className="py-20 bg-gradient-to-br from-white to-green-50 scroll-mt-20">
      <div className="container mx-auto px-4">
        <h2 className="text-5xl font-bold mb-16 text-center text-green-800">{content.title}</h2>
        <div className="space-y-12">
          <div className="bg-white p-8 rounded-xl shadow-lg mb-8">
            <h3 className="text-2xl font-semibold mb-4 text-green-700">{content.subtitle}</h3>
            ...
            {content.features.map((feature, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h4 className="text-xl font-semibold mb-2 text-green-700">{feature.title}</h4>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-green-600 p-8 rounded-xl shadow-lg text-white transform hover:scale-105 transition-all duration-300">
              <h3 className="text-3xl font-bold mb-4 text-center">{content.promotion.title}</h3>
              <p className="text-2xl mb-2 text-center">{content.promotion.price}</p>
